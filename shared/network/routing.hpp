...
struct RoutingCapabilities { AddressFamily address_family{AddressFamily::DualStack}; std::vector<Protocol> protocols{Protocol::Static,Protocol::Connected,Protocol::RIP,Protocol::RIPng,Protocol::OSPFv2,Protocol::OSPFv3,Protocol::BGP4,Protocol::BABEL,Protocol::BFD,Protocol::VRRP}; bool hardware_offload{false}; bool software_defined{true}; };
